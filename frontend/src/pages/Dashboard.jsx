        ...
        return (
            <div className="py-6 space-y-6">
                ...
                <div className="card-glow p-6 animate-pulse">
                    <div className="h-6 bg-surface-700/50 rounded w-1/3 mb-4" />
                    <div className="h-12 bg-surface-700/50 rounded w-1/2 mb-6" />
                    <div className="flex gap-4">
                        <div className="w-32 h-32 bg-surface-700/50 rounded-full" />
                ...
                <div className="card p-6 animate-pulse">
                    <div className="h-5 bg-surface-700/50 rounded w-1/4 mb-4" />
                    <div className="space-y-3">
                        {[1, 2, 3].map((i) => (
                            <div key={i} className="flex items-center gap-3">
                                <div className="w-10 h-10 bg-surface-700/50 rounded-lg" />
                                <div className="flex-1">
                                    <div className="h-4 bg-surface-700/50 rounded w-1/2 mb-1" />
